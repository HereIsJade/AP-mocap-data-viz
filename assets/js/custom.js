...
(function( $ ){
   ...
   $('.mu-video-play-btn').on('click', function(event) {
		...
		$('#mohul').on('click', function(event) {

         event.preventDefault();

         $('.mu-video-iframe-area').addClass('mu-video-iframe-display');

 				 $('.mu-video-iframe-area').find('iframe').attr("src","https://www.youtube.com/embed/lnvkVW9xFfg");

     });

		$('#orleans').on('click', function(event) {

         event.preventDefault();

         $('.mu-video-iframe-area').addClass('mu-video-iframe-display');

 				 $('.mu-video-iframe-area').find('iframe').attr("src","https://www.youtube.com/embed/NyU05o6AfcI");

     });
		 $('#elephants').on('click', function(event) {

          event.preventDefault();

          $('.mu-video-iframe-area').addClass('mu-video-iframe-display');

  				 $('.mu-video-iframe-area').find('iframe').attr("src","https://www.youtube.com/embed/oasYgZ1x8FQ");
			...
			$('#blue').on('click', function(event) {
	         ...
	         $('.mu-video-iframe-area').addClass('mu-video-iframe-display');
	 				 ...
	 				 $('.mu-video-iframe-area').find('iframe').attr("src","https://www.youtube.com/embed/b7mHIPP2R64");
